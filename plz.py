...
rounded_list = [[round(coord) for coord in point] for point in xys_ls]
# import cv2
...
ax.scatter(x_coords, y_coords, c='red', s=40, marker='o')
...
# for n,p in enumerate(points3D):
#     if points3D[p].anomaly_features is not None:
#         print(f"Point ID: {p}, Anomaly Features: {points3D[p].anomaly_features}")
