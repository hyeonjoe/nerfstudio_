...
try:
    from gsplat.rendering import rasterization,custom_rasterization
except ImportError:
...
@dataclass
class custom_SplatfactoModelConfig(ModelConfig):
...
class SplatfactoModel(Model):
    ...
    config: custom_SplatfactoModelConfig

    def __init__(
        self,
        *args,
        seed_points: Optional[Tuple[torch.Tensor, torch.Tensor, torch.Tensor]] = None,#changed typehinting
        **kwargs,
    ):
    ...
    def get_outputs(self, camera: Cameras) -> Dict[str, Union[torch.Tensor, List]]:
        ...
        render, alpha, self.info = custom_rasterization(
            ...
            anomals=anomals_crop,  #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ need to be removed later
            Ks=K,  # [1, 3, 3]
            width=W,
            height=H,
            packed=False,
